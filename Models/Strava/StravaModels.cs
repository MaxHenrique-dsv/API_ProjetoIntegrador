...
public sealed record StravaActivity
{
    ...
    /// <summary>Distância em metros.</summary>
    [JsonPropertyName("distance")]
    public double Distance { get; init; }

    /// <summary>Tempo decorrido em segundos.</summary>
    [JsonPropertyName("elapsed_time")]
    public int ElapsedTime { get; init; }

    /// <summary>Tempo em movimento em segundos.</summary>
    ...
    /// <summary>Pace médio em segundos por km.</summary>
